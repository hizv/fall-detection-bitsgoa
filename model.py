...
i = i+1
#LR
classifier = _TrainModel_SingleThread(X_train, X_test, y_train, y_test, "Logistic Regression")
f,t,a = _TestModel_SingleThread(classifier)
fpr.append(f)
tpr.append(t)
auc.append(a)
...
for x in range(0, i+1):
	plt.plot(fpr[x],tpr[x], label = algorithms[x] + " , AUC Score: " + str(round(auc[x], 3)) , linestyle = lines[x])
